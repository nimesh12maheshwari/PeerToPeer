...
public class Login extends javax.swing.JFrame {
    ...
    private void ButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonActionPerformed
        ...
        String ip=i1.getText()+"."+i2.getText()+"."+i3.getText()+"."+i4.getText(); // saves the friends ip 
        Main.ip=ip; //giving value of ip for further connection
        Main.name=nme;
        Main main=new Main(); 
        main.setVisible(true);// for opening chat area
        this.dispose();// for closing current frame
